...
class PriorBox(object):
    ...
    def __init__(self, image_size, feature_maps, aspect_ratios, scale, archor_stride=None, archor_offest=None,
        ...
        if False:
            ...
            if archor_offest:
                self.offset = [[offset[0] / self.image_size[0], offset[1] * self.image_size[1]] for offset in
                               archor_offest]
            else:
            ...
            self.steps = [(16 * (2 ** i) / image_size[0], 16 * (2 ** i) / image_size[1]) for i in
